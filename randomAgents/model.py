...
from mesa.time import RandomActivation #Step is the only method, it takes all agents, makes a shuffle to determine which one goes first, and then each agent will move
