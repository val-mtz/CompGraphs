...
canvas_element = CanvasGrid(forest_fire_portrayal, 50, 50, 500, 500) #50 x 50 grid
...
model_params = {
    "height": 50,
    "width": 50,
    "density": Slider("Cell density", 0.35, 0.01, 1.0, 0.01),
}
...
server = ModularServer(
    ForestFire, [canvas_element, tree_chart, pie_chart], "Cell Automaton 2", model_params
)
